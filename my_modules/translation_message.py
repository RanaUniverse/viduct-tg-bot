"""
This module i make which will help me to get the values from different
langugage and what key i want to use it will use this and
help me to get values from differnet language code
"""
...
JSON_TEMPLATES_DIR = Path("language_templates")
...
def get_value_from_language_json(
    ...
    try:
        with open(file_path, "r", encoding="utf-8") as f:
            json_content_dict: dict[str, str] = json.load(f)
...
if __name__ == "__main__":
    abc = get_value_from_language_json(key_name="settings_cmd", language_code="bn")
    print(abc)
